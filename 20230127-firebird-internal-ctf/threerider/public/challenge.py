...
#
# (Obseleted - This was a comment in HKCERT CTF 2021. Please delete this.)
# Mystiz: I just want to make a challenge as soon as possible. Let's do brainless copy and paste.
#
# Mystiz: I just want to make a challenge as soon as possible. Let's do brainless copy and paste again.
class TenetAES():
...
def main():
    ...
    assert re.match(r'firebird\{\w{53}\}', flag)
